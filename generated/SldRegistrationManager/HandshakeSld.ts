...
export class RoyaltyPayoutAddressSet extends ethereum.Event {
  get params(): RoyaltyPayoutAddressSet__Params {
    return new RoyaltyPayoutAddressSet__Params(this);
  }
}

export class RoyaltyPayoutAddressSet__Params {
  _event: RoyaltyPayoutAddressSet;

  constructor(event: RoyaltyPayoutAddressSet) {
    this._event = event;
  }
...
export class RoyaltyPayoutAmountSet extends ethereum.Event {
  get params(): RoyaltyPayoutAmountSet__Params {
    return new RoyaltyPayoutAmountSet__Params(this);
  }
}

export class RoyaltyPayoutAmountSet__Params {
  _event: RoyaltyPayoutAmountSet;

  constructor(event: RoyaltyPayoutAmountSet) {
    this._event = event;
  }
...
export class HandshakeSld__getSldDetailsResultValue0Struct extends ethereum.Tuple {
  get Id(): BigInt {
...
export class HandshakeSld__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class HandshakeSld extends ethereum.SmartContract {
  static bind(address: Address): HandshakeSld {
    return new HandshakeSld("HandshakeSld", address);
  }
  ...
  getRegistrationStrategy(_parentNamehash: Bytes): Address {
    let result = super.call(
  ...
  getSldDetails(
    ...
    let result = super.call(
      "getSldDetails",
      "getSldDetails(address[],uint256[],string[],uint256[]):((uint256,uint256,string,uint256,uint256)[])",
      [
  ...
  namehashToParentMap(param0: Bytes): Bytes {
    let result = super.call(
      "namehashToParentMap",
  ...
  try_namehashToParentMap(param0: Bytes): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "namehashToParentMap",
      "namehashToParentMap(bytes32):(bytes32)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  royaltyPayoutAddressMap(param0: Bytes, param1: Address): Address {
    let result = super.call(
  ...
  royaltyPayoutAmountMap(param0: Bytes): BigInt {
    let result = super.call(
  ...
  try_royaltyPayoutAmountMap(param0: Bytes): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "royaltyPayoutAmountMap",
      "royaltyPayoutAmountMap(bytes32):(uint256)",
      [ethereum.Value.fromFixedBytes(param0)]
...
export class RegisterSldCall extends ethereum.Call {
  get inputs(): RegisterSldCall__Inputs {
    return new RegisterSldCall__Inputs(this);
  }

  get outputs(): RegisterSldCall__Outputs {
    return new RegisterSldCall__Outputs(this);
  }
}

export class RegisterSldCall__Inputs {
  _call: RegisterSldCall;

  constructor(call: RegisterSldCall) {
    this._call = call;
  }
...
export class RegisterSldCall__Outputs {
  _call: RegisterSldCall;
...
export class SetRegistrationManagerCall extends ethereum.Call {
  get inputs(): SetRegistrationManagerCall__Inputs {
    return new SetRegistrationManagerCall__Inputs(this);
  }

  get outputs(): SetRegistrationManagerCall__Outputs {
    return new SetRegistrationManagerCall__Outputs(this);
  }
}

export class SetRegistrationManagerCall__Inputs {
  _call: SetRegistrationManagerCall;

  constructor(call: SetRegistrationManagerCall) {
    this._call = call;
  }

  get _registrationManager(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetRegistrationManagerCall__Outputs {
  _call: SetRegistrationManagerCall;
